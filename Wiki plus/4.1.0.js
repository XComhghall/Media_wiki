 ...
 * Do NOT use SRI with dynamically generated files. For more information:
    ...
    n.n = function(t) {
        ...
        function() {
            ...
            var Q = function() {
                    ...
                    return e = t, n = [{
                        key: "getEditToken",
                        value: (l = N(regeneratorRuntime.mark((function t() {
                            var e;
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                        ...
                        key: "getPageInfo",
                        value: (s = N(regeneratorRuntime.mark((function t(e) {
                            var n, r, i, o, a;
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                    ...
                                    case 13:
                                        ...
                                        return t.abrupt("return", {});
                                    case 17:
                                        return a = o.query.pages[Object.keys(o.query.pages)[0]].revisions[0], n && (this.pageInfoCache[n] = a), t.abrupt("return", {
                        ...
                        value: (u = N(regeneratorRuntime.mark((function t(e) {
                            ...
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return n = e.section, i = e.revisionId, t.prev = 1, t.next = 4, fetch("".concat(location.protocol, "//").concat(location.host).concat(r.scriptPath, "/index.php?oldid=").concat(i, "&section=").concat(n, "&action=raw"));
                                    case 4:
                                        return t.next = 6, t.sent.text();
                                    case 6:
                                        return o = t.sent, t.abrupt("return", o);
                                    case 10:
                                        t.prev = 10, t.t0 = t.catch(1), j.error("fail_to_get_wikitext");
                                    case 13:
                                    case "end":
                                        return t.stop()
                                }
                        ...
                        key: "edit",
                        value: (a = N(regeneratorRuntime.mark((function t() {
                        ...
                        value: (o = N(regeneratorRuntime.mark((function t(e) {
                            var n, r;
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                    ...
                                    case 2:
                                        return n = t.sent, r = n.revisionId, t.abrupt("return", r);
                                    case 5:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    }], n && M(e.prototype, n), i && M(e, i), Object.defineProperty(e, "prototype", {
                        writable: !1
                    }), t
                }(),
                D = new Q;
            ...
            var J = function() {
                    ...
                    return e = t, n = [{
                        ...
                        value: (a = Y(regeneratorRuntime.mark((function t() {
                            var e, n, r, i, o, a = arguments;
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        if (e = a.length > 0 && void 0 !== a[0] ? a[0] : {}, n = e.section, i = -1 === (r = void 0 === n ? "" : n) ? "" : r, !this.sectionCache[i]) {
                                            t.next = 4;
                                            break
                                        }
                                        return t.abrupt("return", this.sectionCache[i]);
                                    case 4:
                                        return t.next = 6, D.getWikiText({
                                            section: i,
                                            revisionId: this.revisionId
                                        });
                                    case 6:
                                        return o = t.sent, j.info("Wikitext of ".concat(this.title, "#").concat(r, " fetched.")), this.sectionCache[i] = o, t.abrupt("return", o);
                                    case 10:
                                    case "end":
                                        return t.stop()
                                }
